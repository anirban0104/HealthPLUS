exec(open('E:\\#Code\\project\\register.py').read())
...
#HealthPLUS - an App to stay healthy

#importing the required modules
from tkinter import *       # do pip install tk
from tkinter import ttk     # do pip install tk
from playsound import *
from playsound import playsound
#playsound('E://#Code//project//sounds//xpStart.mp3')
...
photo = PhotoImage(file = "E:\\#Code\\project\\1.png")
...
b1 = Button(frame, fg="red", text="Allergies", command=allergies)
b1.pack(side=LEFT, padx=23)

b2 = Button(frame, fg="red", text="Colds and Flu", command=cold_and_flu)
b2.pack(side=LEFT, padx=23)

b3 = Button(frame, fg="red", text="Conjunctivitis (Pink Eye)", command=conjunctivitis)
b3.pack(side=LEFT, padx=23)

b4 = Button(frame, fg="red", text="Diarrhea", command=diarrhea)
b4.pack(side=LEFT, padx=23)

b5 = Button(frame, fg="red", text="Headaches", command=headaches)
b5.pack(side=LEFT, padx=23)

b6 = Button(frame, fg="red", text="Mononucleosis", command=mononucleosis)
b6.pack(side=LEFT, padx=23)

b7 = Button(frame, fg="red", text="Stomach Aches", command=stomach_aches)
